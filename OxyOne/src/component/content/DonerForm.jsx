...
const DonorForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-4">
        <label className="block text-green-700">Would you like to remain anonymous?</label>
        <select
          name="anonymous"
      ...
      <div className="mb-4">
        <label className="block text-green-700">Would you like to receive updates on our work?</label>
        <select
          name="updates"
          value={data.updates}
          onChange={handleChange}
